    ...
    <div className={styles['landing-page']}>
      ...
      <section className="uniprot-grid">
        ...
        <div className="uniprot-grid-cell--small-span-12 uniprot-grid-cell--medium-span-8">
          ...
          information. Supporting data includes keywords, subcellular locations,
          automatic annotation rules, human diseases, taxonomy, cross-referenced
          databases and literature citations. By integrating this data, it
          ...
          Supporting data serves as a vital resource for making UniProt entries
          more informative and accessible for biological and biomedical
          research.
        </div>
        ...
        <div className="uniprot-grid-cell--small-span-12 uniprot-grid-cell--medium-span-4">
          ...
          <div className={styles.category}>
            ...
            main features and attributes of a protein entry. Categories include:
            Biological Process, Molecular Function, Technical Terms, Ligands and
            Cofactors, and Applications.
          </div>
          <Link
            to={{
        ...
        <div className="uniprot-grid-cell--small-span-12 uniprot-grid-cell--medium-span-4">
          <h3 data-article-id="subcellular_location">Subcellular locations</h3>
          <div className={styles.category}>
            Specifies where the protein is located within a cell or organism,
            providing insight into its potential role. Experimental evidence or
            computational predictions supporting the localization are often
            included.
          </div>
          <Link
            to={{
        ...
        >
          ...
          <div>
            Automatic annotations in UniProt provides functional and structural
            insights for protein sequences and supplements manually curated data
            using two key systems: UniRule and ARBA.
          </div>
        ...
        <div className="uniprot-grid-cell--small-span-12 uniprot-grid-cell--medium-span-8">
          ...
          <div className={styles.category}>
            Links to databases like PDB (Protein Data Bank), Gene Ontology (GO),
            Ensembl, and RefSeq.
          </div>
          <Link
            to={{
          ...
          <div>
            If you would like your database to be linked with UniProt to expand
            its integration with protein-related data, please fill out this
            form, and a member of our team will be in contact.
          </div>
          <form
        ...
        >
          <h3 data-article-id="literature_references">Literature citations</h3>
          <div className={styles.category}>
