...
describe('parseIdsFromSearchParams', () => {
  it('should parse a single ID', () => {
    expect(parseIdsFromSearchParams('P05067')).toMatchObject([
      { id: 'P05067' },
    ]);
  });
  it('should parse a single ID with a range', () => {
    expect(parseIdsFromSearchParams('P05067[1-10]')).toMatchObject([
      { id: 'P05067', start: 1, end: 10 },
    ]);
  });
  it('should parse several IDs', () => {
    expect(parseIdsFromSearchParams('P05067,P05068')).toMatchObject([
      { id: 'P05067' },
      { id: 'P05068' },
    ]);
  });
  it('should parse several IDs some with a range', () => {
    expect(parseIdsFromSearchParams('P05067[1-10],P05068')).toMatchObject([
      { id: 'P05067', start: 1, end: 10 },
      { id: 'P05068' },
    ]);
  });
