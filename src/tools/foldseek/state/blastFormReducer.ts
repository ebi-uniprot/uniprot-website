...
import { FOLDSEEK_LIMIT, getAutoMatrixFor } from '../components/FoldseekForm';

import * as blastFormActions from './blastFormActions';

import { BlastFormValues, BlastFields } from '../config/FoldseekFormData';
...
const isInvalid = (parsedSequences: SequenceObject[]) =>
  ...
  parsedSequences.length > FOLDSEEK_LIMIT ||
