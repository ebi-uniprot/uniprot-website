...
/* Parameters of a foldseek job as required by the server */
// https://search.mmseqs.com/docs/ => docs for mmseqs, so not same URL base, but similar API
export type Databases = Array<
  'afdb50' | 'blastx' | 'blastn' | 'tblastx' | 'tblastn'
>;
