...
export const FOLDSEEK_LIMIT = 1;

const title = namespaceAndToolsLabels[JobTypes.FOLDSEEK];
...
const BlastForm = ({ initialFormValues }: Props) => {
  ...
  const submitFoldseekJob = (event: FormEvent | MouseEvent) => {
    event.preventDefault();
  ...
  return (
    <>
      ...
      <form
        onSubmit={submitFoldseekJob}
        onReset={handleReset}
        aria-label="Foldseek job submission form"
      >
        {/* <fieldset>
          <section className="tools-form-section__item">
            <legend>
              Find a structure to run Foldseek similarity search by UniProt ID
              (e.g. P05067 or A4_HUMAN) or PDB ID.
            </legend>
        ...
        <fieldset>
          <section className="text-block">
            ...
            <SequenceSubmission
              placeholder="Structure information in PDB format"
...
const FoldseekFormWithProvider = () => (
...
export default FoldseekFormWithProvider;
