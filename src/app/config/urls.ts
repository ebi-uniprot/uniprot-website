...
import { type Database } from '../../jobs/blast/types/blastServerParameters';
import { type FormParameters as IdMappingFormParameters } from '../../jobs/id-mapping/types/idMappingFormParameters';
...
export enum Location {
  Home = 'Home',
  // Main data
  UniProtKBStatistics = 'UniProtKBStatistics',
...
export const LocationToPath: Record<Location, string> = {
  [Location.Home]: '/',
  // Main data
  [Location.UniProtKBStatistics]: `/${Namespace.uniprotkb}/statistics`,
