...
const databaseInfoMaps: DatabaseInfoMaps = {
  ...
  databaseToDatabaseInfo: {
    ...
    SMR: {
      ...
      category: '3DS',
      uriLink:
        'https://swissmodel.expasy.org/repository/uniprot/%id?csm=%crc64',
      attributes: [{ name: 'Description', xmlTag: 'description' }],
    },
    ...
    WormBase: {
      ...
      attributes: [
        ...
        },
        {
          ...
          xmlTag: 'gene ID',
          uriLink:
            'http://www.wormbase.org/db/gene/gene?name=%GeneId;class=Gene',
        },
    ...
    Bgee: {
      ...
      attributes: [
        { name: 'ExpressionPatterns', xmlTag: 'expression patterns' },
      ],
    },
    CleanEx: {
      name: 'CleanEx',
    ...
    ProtoNet: {
      ...
      category: 'FMD',
      uriLink:
        'http://www.protonet.cs.huji.ac.il/sp.php?prot=%primaryAccession',
      attributes: [{ name: 'Description', xmlTag: 'description' }],
      implicit: true,
      linkedReason: 'All UniProtKB entries',
    },
