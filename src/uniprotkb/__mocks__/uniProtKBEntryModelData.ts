...
// Generated by backend on 2022-08-02

/*
Modifications applied to backend file:
  - citation IDs are identical in the original backend mock, since they would trigger react key warning I've manually changed them here
  - modified the UniProtKB ID to be "more" valid (no whitespace)
  - interactantOne.uniProtKBAccession P12345 -> P21802
  - interactantTwo.uniProtKBAccession P12346 -> P21802 
  - position: 'rna position' -> 1 // overriding to make it a number for types
*/
...
const mock: UniProtkbAPIModel = {
  ...
  organism: {
    ...
    taxonId: 9606,
    evidences: [
      { evidenceCode: 'ECO:0000256', source: 'PIRNR', id: 'PIRNR001363' },
    ],
    lineage: ['lineage 1'],
  },
  organismHosts: [
  ...
  genes: [
    {
      geneName: {
        evidences: [
          { evidenceCode: 'ECO:0000256', source: 'PIRNR', id: 'PIRNR001360' },
        ],
        value: 'some Gene',
      },
      synonyms: [
        {
          evidences: [
            { evidenceCode: 'ECO:0000256', source: 'PIRNR', id: 'PIRNR001361' },
          ],
          value: 'some Syn',
        },
      ],
      orderedLocusNames: [
        {
          evidences: [
            { evidenceCode: 'ECO:0000256', source: 'PIRNR', id: 'PIRNR001362' },
          ],
          value: 'some locus',
        },
      ],
      orfNames: [
        {
          evidences: [
            { evidenceCode: 'ECO:0000269', source: 'PubMed', id: '11389730' },
          ],
          value: 'some orf',
        },
      ],
  ...
  comments: [
    ...
    },
    {
      texts: [
        {
          evidences: [
            { evidenceCode: 'ECO:0000256', source: 'PIRNR', id: 'PIRNR001365' },
          ],
          value: 'value',
        },
      ],
  ...
  internalSection: {
    internalLines: [{ value: 'line value', type: 'DR' }],
    evidenceLines: [
      {
    ...
    sourceLines: [{ value: 'source line value' }],
  },
  lineages: [
    {
      scientificName: 'Scientific Name',
