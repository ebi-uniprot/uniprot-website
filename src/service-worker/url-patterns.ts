export const externalAPIs = /^https?:\/\/((www|api)\.rhea-db\.org|api\.geneontology\.org|www\.ebi\.ac\.uk\/(interpro\/api|pdbe))\//;

export const sameOriginImagesAndFonts = /\.(?:png|gif|jpe?g|webp|svg|ico|woff2?|ttf|eot)$/;
