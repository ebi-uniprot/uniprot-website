...
// Data from /api/unirule/search?query=insulin&size=2
const mock: UniRuleAPIModel[] = [
  {
    ...
    statistics: { reviewedProteinCount: 0, unreviewedProteinCount: 1296 },
  ...
  },
  {
    ...
    statistics: { reviewedProteinCount: 0, unreviewedProteinCount: 32 },
